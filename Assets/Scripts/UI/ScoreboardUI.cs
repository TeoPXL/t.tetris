...
namespace UI
{
    public class ScoreboardUI : MonoBehaviour
    {
        ...
        [Tooltip("The prefab for a single score row.")] [SerializeField]
        private GameObject scoreRowPrefab;

        [Tooltip("The button to return to the main menu.")] [SerializeField]
        ...
        private void UpdateScoreboard()
        {
            ...
            {
                Debug.LogWarning(
                    "ScoreboardUI: ScoreBoard instance not found. High scores cannot be loaded. Start the game from the MainMenu to initialize the ScoreBoard.");
                return;
            }
