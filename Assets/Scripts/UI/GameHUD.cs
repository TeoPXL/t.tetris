...
namespace UI
{
    ...
    {
        [Header("References")] public GameObject cellPrefab; // Needs to be assigned by SetupTools

        [Header("HUD Elements")] public TextMeshProUGUI scoreText;
        public TextMeshProUGUI levelText; // Optional polish

        [Header("Panels")] public GameObject pauseMenuPanel;
        public GameObject gameOverPanel;

        [Header("Buttons")] public Button pauseButton;
        public Button resumeButton;
        public Button optionsButton;
        public Button quitButton;

        [Header("Game Over Elements")] public TextMeshProUGUI finalScoreText;
        public Button restartButton;
        public Button menuButton;
        public TMP_InputField nameInputField;
        public Button submitScoreButton;

        [Header("Hold & Next Containers")] public RectTransform holdContainer;
        public List<RectTransform> nextContainers;

        private int currentScore = 0;

        [Header("Audio")] public AudioClip gameMusic;
        ...
        {
            // Only update if score actually changed - prevents redundant TextMeshPro renders
        ...
        private void SubmitScore()
        {
            ...
            {
                Debug.LogError(
                    "GameHUD: ScoreBoard.Instance is NULL. The ScoreBoard GameObject is missing from the scene.");
