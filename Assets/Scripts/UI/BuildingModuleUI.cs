...
namespace UI
{
    public class BuildingModuleUI : MonoBehaviour
    {
        ...
        private void UpdateUITexts()
        {
            ...
            if (savedListTitleText != null)
                savedListTitleText.text = LocalizationManager.Instance.GetText("saved_blocks");
        ...
        private IEnumerator SaveButtonFeedback()
        {
            ...
            string savedText = (LocalizationManager.Instance != null)
                ? LocalizationManager.Instance.GetText("saved_feedback")
                : "Saved!";
